...
<body>
    <div class="app">
        ...
        <div class="inner">
            ...
            <div class="domains">.terbaru-2022.com</div>
        </div>
        ...
        <div class="details">
            ...
            <div class="active">
                <p class="info">Terima kasih, telah menggunakan domain dari kami</p>
            </div>
        </div>

        <span class="copy">Maded With ❤️ By Dil Hosting</span>
    </div>
    ...
    <script>
        function fun(){
                ...
                $('.process').fadeIn();
                $.get('docs/lookup.php?domain='+domain.val()+'.terbaru-2022.com',function(r){
                    if(!r.is_exsist){
                        $('.process').hide();
                        $('#query').fadeIn();
        ...
        function change(){
            ...
            $.get('docs/add_domain.php?session='+session+'&domain='+domain.val()+'.terbaru-2022.com&ip='+ip,function(r){
                console.log(r)
                    if(r.success){
                        $('.process').hide();
                        $('.success').fadeIn();
